...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){
        ...
        if(x < max_fields){
            ...
            row += '<td> @ T<input type="text" size="10" placeholder="Time" name="correction'+x+'"></td>';
            row += '<td><input title="'+hint+'" type="text" size="10" placeholder="Parameter" name="correction'+x+'"></td>';
