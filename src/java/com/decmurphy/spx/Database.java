  ...
  public String buildProfilesList(String pathToPropertiesFile) {
    ...
    try {
      ...
      while (rs.next() && rs2.next()) {
        ...
        tabs.append("                <tr><td>1st Stage Ign	 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"mei1_time\"	 value=\"").append(rs.getDouble("MEI_1")							).append("\"/>s</td></tr>\n");
        ...
        tabs.append("                <tr><td>MECO-1					 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"meco1_time\"	 value=\"").append(rs.getDouble("MECO_1")				  		).append("\"/>s</td></tr>\n");
        ...
        tabs.append("                <tr><td>2nd Stage Ign	 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"sei1_time\"	 value=\"").append(rs.getDouble("SEI_1")							).append("\"/>s</td></tr>\n");
        tabs.append("                <tr><td>BoostBack On		 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"mei2_time\"	 value=\"").append(rs.getDouble("MEI_2")							).append("\"/>s</td></tr>\n");
        tabs.append("                <tr><td>BoostBack Off	 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"meco2_time\"	 value=\"").append(rs.getDouble("MECO_2")						  ).append("\"/>s</td></tr>\n");
        tabs.append("                <tr><td>Re-Entry On		 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"mei3_time\"	 value=\"").append(rs.getDouble("MEI_3")						  ).append("\"/>s</td></tr>\n");
        tabs.append("                <tr><td>Re-Entry Off		 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"meco3_time\"	 value=\"").append(rs.getDouble("MECO_3")						  ).append("\"/>s</td></tr>\n");
        tabs.append("                <tr><td>Landing On			 </td><td> @ T</td><td><input type=\"text\" size=\"15\" name=\"mei4_time\"	 value=\"").append(rs.getDouble("MEI_4")						  ).append("\"/>s</td></tr>\n");
        tabs.append("              </table>\n");
