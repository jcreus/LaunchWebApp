  ...
  public String buildProfilesList(String pathToPropertiesFile) {
    ...
    try {
      ...
      while (rs.next() && rs2.next()) {
        ...
        tabs.append("                <tr><td>Landing Legs</td> <td>    </td><td><input type=\"text\" name=\"legs\" value=\"").append(rs.getBoolean("Legs") ? "Yes" : "No").append("\"          /></td><td>Coriolis Effect</td><td><input type=\"radio\" name=\"coast_level\" value=\"coarse\" />Coarse <br /></td></tr>\n");
        tabs.append("                <tr><td>1st Stage Ign</td><td> @ T</td><td><input type=\"text\" name=\"mei_time\" value=\"").append(rs.getDouble("MEI_1")).append("\"    />s   </td><td><input type=\"text\" name=\"coriolis\" value=\"Yes\"/></td><td><input type=\"radio\" name=\"coast_level\" value=\"medium\" />Medium <br /></td></tr>\n");
        tabs.append("                <tr><td>Launch</td>       <td> @ T</td><td><input type=\"text\" name=\"launch_time\" value=\"0.0\"  />s   </td><td></td><td><input type=\"radio\" name=\"coast_level\" value=\"fine\" checked/>Fine <br /></td></tr>\n");
        ...
        tabs.append("                <tr><td></td>             <td>    </td><td><input type=\"text\" name=\"pitch\" value=\"").append(rs.getDouble("Pitch")).append("\"      />rads x</td>\n");
        tabs.append("                                                       <td><input type=\"text\" name=\"yaw\" value=\"").append(rs.getDouble("Yaw")).append("\"        />rads</td></tr>\n");
        tabs.append("                <tr><td>MECO</td>         <td> @ T</td><td><input type=\"text\" name=\"meco_time\" value=\"").append(rs.getDouble("MECO_1")).append("\"  />s   </td><td></td><td rowspan=\"5\"><input class=\"launch_button\" type=\"submit\" value=\"LAUNCH\"/></td></tr>\n");
