      ...
      if (!paramName.isEmpty()) {
        ...
        try {
          ...
          switch (paramName) {
            ...
            case "mei1_time":
              mission.Profile().addEvent("firstStageIgnition", Double.parseDouble(paramValues[0])).addExtraInfo("stage", 0);
              break;
            case "launch_time":
              mission.Profile().addEvent("releaseClamps", Double.parseDouble(paramValues[0])).addExtraInfo("stage", 0);
              break;
            case "pitch_time":
              mission.Profile().addEvent("pitchKick", Double.parseDouble(paramValues[0])).addExtraInfo("stage", 0);
              break;
            case "pitch":
            ...
            case "yaw":
              ...
              break;
            case "meco1_time":
              mission.Profile().addEvent("MECO1", Double.parseDouble(paramValues[0])).addExtraInfo("stage", 0);
              break;
            case "fss_time":
              mission.Profile().addEvent("firstStageSep", Double.parseDouble(paramValues[0]));
              break;
            case "sei1_time":
              mission.Profile().addEvent("secondStageIgnition", Double.parseDouble(paramValues[0])).addExtraInfo("stage", 1);
              break;

            case "mei2_time":
              mission.Profile().addEvent("boost_start", Double.parseDouble(paramValues[0]));
              break;
            case "meco2_time":
              mission.Profile().addEvent("boost_end", Double.parseDouble(paramValues[0]));
              break;
            case "mei3_time":
              mission.Profile().addEvent("entry_start", Double.parseDouble(paramValues[0]));
              break;
            case "meco3_time":
              mission.Profile().addEvent("entry_end", Double.parseDouble(paramValues[0]));
              break;
            case "mei4_time":
