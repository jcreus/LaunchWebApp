  ...
  public String buildProfilesList(String pathToPropertiesFile) {
    ...
    try {
      ...
      while (rs.next() && rs2.next()) {
        ...
        sb2.append("  <div class=\"tab-pane fade").append(id == 1 ? " in active" : "").append("\" id=\"tab").append(id).append("\">\n");
        ...
        sb2.append("        <tr><td>Landing Legs</td> <td>    </td><td><input type=\"text\" name=\"legs\" value=\"").append(rs.getBoolean("Legs")).append("\"          />    </td><td><input type=\"radio\" name=\"coast_level\" value=\"medium\" />Medium <br /></td></tr>\n");
