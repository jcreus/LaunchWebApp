...
public class HoverSlam {
	...
	private static double throttleTest(Stage stage, double throttle) {
		...
		double vel;
		double dragForce, thrustForce, gravityForce;

		do {

			copyStage.setQ(0.5 * densityAtAltitude(copyStage.alt()) * copyStage.VR * copyStage.VR);
			dragForce = copyStage.getQ() * copyStage.getAeroProp("Cd") * copyStage.getAeroProp("XA");
			...
			copyStage.S = sqrt(copyStage.pos[0] * copyStage.pos[0] + copyStage.pos[1] * copyStage.pos[1] + copyStage.pos[2] * copyStage.pos[2]);
			...
			copyStage.A = sqrt(copyStage.accel[0] * copyStage.accel[0] + copyStage.accel[1] * copyStage.accel[1] + copyStage.accel[2] * copyStage.accel[2]);

			copyStage.absVel[0] += copyStage.accel[0] * dt;
			copyStage.absVel[1] += copyStage.accel[1] * dt;
			copyStage.absVel[2] += copyStage.accel[2] * dt;
			copyStage.VA = sqrt(copyStage.absVel[0] * copyStage.absVel[0] + copyStage.absVel[1] * copyStage.absVel[1] + copyStage.absVel[2] * copyStage.absVel[2]);
			...
			copyStage.beta[0] = PI - atan2(sqrt(copyStage.pos[0] * copyStage.pos[0] + copyStage.pos[1] * copyStage.pos[1]), copyStage.pos[2]);
			copyStage.beta[1] = PI + atan2(copyStage.pos[0], copyStage.pos[1]);
