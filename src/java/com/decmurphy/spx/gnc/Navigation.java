...
import static com.decmurphy.spx.physics.Globals.densityAtAltitude;
import static com.decmurphy.spx.physics.Globals.gravityAtRadius;
  ...
  public static void leapfrogStep(Stage stage) {
	...
	try {
	  ...
	  if(stage.landingBurnIsUnderway()) {
		stage.setThrottle(updateLandingThrottle(stage));
	  }
